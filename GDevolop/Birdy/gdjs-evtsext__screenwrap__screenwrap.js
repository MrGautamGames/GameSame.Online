...
{for(var i = 0, len = gdjs.evtsExt__ScreenWrap__ScreenWrap.ScreenWrap.prototype.onCreatedContext.GDObjectObjects2.length ;i < len;++i) {
    gdjs.evtsExt__ScreenWrap__ScreenWrap.ScreenWrap.prototype.onCreatedContext.GDObjectObjects2[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior")).SetBottomBorder(gdjs.evtTools.window.getGameResolutionHeight(runtimeScene), eventsFunctionContext);
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__ScreenWrap__ScreenWrap.ScreenWrap.prototype.onCreatedContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScreenWrap__ScreenWrap.ScreenWrap.prototype.onCreatedContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior")).SetRightBorder(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene), eventsFunctionContext);
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = !eventsFunctionContext.getArgument("Horizontal");
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = !eventsFunctionContext.getArgument("Vertical");
}
if (isConditionTrue_0) {
{eventsFunctionContext.returnValue = false;}}
...
{for(var i = 0, len = gdjs.evtsExt__ScreenWrap__ScreenWrap.ScreenWrap.prototype.SetTopBorderContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScreenWrap__ScreenWrap.ScreenWrap.prototype.SetTopBorderContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setBorderTop((Number(eventsFunctionContext.getArgument("Value")) || 0));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__ScreenWrap__ScreenWrap.ScreenWrap.prototype.SetLeftBorderContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScreenWrap__ScreenWrap.ScreenWrap.prototype.SetLeftBorderContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setBorderLeft((Number(eventsFunctionContext.getArgument("Value")) || 0));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__ScreenWrap__ScreenWrap.ScreenWrap.prototype.SetBottomBorderContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScreenWrap__ScreenWrap.ScreenWrap.prototype.SetBottomBorderContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setBorderBottom((Number(eventsFunctionContext.getArgument("Value")) || 0));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__ScreenWrap__ScreenWrap.ScreenWrap.prototype.SetRightBorderContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScreenWrap__ScreenWrap.ScreenWrap.prototype.SetRightBorderContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setBorderRight((Number(eventsFunctionContext.getArgument("Value")) || 0));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__ScreenWrap__ScreenWrap.ScreenWrap.prototype.SetTriggerOffsetContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScreenWrap__ScreenWrap.ScreenWrap.prototype.SetTriggerOffsetContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setTriggerOffset((Number(eventsFunctionContext.getArgument("Value")) || 0));
}
}}
