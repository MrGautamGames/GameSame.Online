...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__Sticker__IsStuck.func(runtimeScene, gdjs.TutorialCode.mapOfGDgdjs_9546TutorialCode_9546GDExtraBallObjects4Objects, "Sticker", gdjs.TutorialCode.mapOfGDgdjs_9546TutorialCode_9546GDBlockObjects4Objects, null);
if (isConditionTrue_0) {
/* Reuse gdjs.TutorialCode.GDBlockObjects4 */
{for(var i = 0, len = gdjs.TutorialCode.GDBlockObjects4.length ;i < len;++i) {
...
for (var i = 0, k = 0, l = gdjs.TutorialCode.GDBlockObjects4.length;i<l;++i) {
    if ( gdjs.TutorialCode.GDBlockObjects4[i].getVariableBoolean(gdjs.TutorialCode.GDBlockObjects4[i].getVariables().get("SuperPowerup"), true, false) ) {
...
{for(var i = 0, len = gdjs.TutorialCode.GDFadeInOutObjects2.length ;i < len;++i) {
    gdjs.TutorialCode.GDFadeInOutObjects2[i].getBehavior("FlashTransitionPainter").PaintEffect("0;0;0", 0.5, "Flash", "Backward", 0, null);
}
}}
...
};gdjs.TutorialCode.asyncCallback16110836 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.TutorialCode.asyncCallback16110836(runtimeScene, asyncObjectsList)));
}
}
...
for (var i = 0, k = 0, l = gdjs.TutorialCode.GDLargePlayButtonObjects2.length;i<l;++i) {
    if ( gdjs.TutorialCode.GDLargePlayButtonObjects2[i].getBehavior("ButtonFSM").IsClicked(null) ) {
        isConditionTrue_0 = true;
...
{gdjs.evtTools.sound.playSound(runtimeScene, "assets\\audio\\audio - FX3352 Mouth Pop 2.aac", false, 50, 2);
    ...
    gdjs.TutorialCode.GDFadeInOutObjects2[i].getBehavior("FlashTransitionPainter").PaintEffect("0;0;0", 0.5, "Flash", "Forward", 255, null);
}
}
{ //Subevents
