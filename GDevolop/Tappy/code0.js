...
gdjs.MenuCode.GDBrandObjects1= [];
gdjs.MenuCode.GDBrandObjects2= [];
gdjs.MenuCode.GDBrandObjects3= [];
gdjs.MenuCode.GDBrandObjects4= [];
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(12192428);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(12194420);
}
}
if (isConditionTrue_0) {
...
gdjs.MenuCode.GDBrandObjects1.length = 0;
gdjs.MenuCode.GDBrandObjects2.length = 0;
gdjs.MenuCode.GDBrandObjects3.length = 0;
gdjs.MenuCode.GDBrandObjects4.length = 0;
