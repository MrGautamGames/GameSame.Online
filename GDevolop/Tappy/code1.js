...
gdjs.GameCode.GDYellowJellyButtonObjects3= [];
gdjs.GameCode.GDYellowJellyButtonObjects4= [];
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11093548);
}
}
if (isConditionTrue_0) {
...
}{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBottomPillarObjects3Objects, 450, (( gdjs.GameCode.GDTopPillarObjects3.length === 0 ) ? 0 :gdjs.GameCode.GDTopPillarObjects3[0].getPointY("")) + 350, "");
...
};gdjs.GameCode.asyncCallback10466876 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.GameCode.asyncCallback10466876(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10464036);
}
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11097140);
}
if (isConditionTrue_0) {
{gdjs.evtTools.runtimeScene.resetTimer(runtimeScene, "pipe_spawn");
}}
...
gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDYellowJellyButtonObjects2Objects = Hashtable.newFrom({"YellowJellyButton": gdjs.GameCode.GDYellowJellyButtonObjects2});
gdjs.GameCode.asyncCallback10470820 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.GameCode.localVariables);
gdjs.copyArray(runtimeScene.getObjects("CurrentScore"), gdjs.GameCode.GDCurrentScoreObjects2);
...
}{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDYellowJellyButtonObjects2Objects, 170, 200, "Gameover");
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.GameCode.asyncCallback10470820(runtimeScene, asyncObjectsList)));
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10470276);
}
if (isConditionTrue_0) {
gdjs.GameCode.GDFlashObjects1.length = 0;

{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDFlashObjects1Objects, 0, 0, "GUI");
}{for(var i = 0, len = gdjs.GameCode.GDFlashObjects1.length ;i < len;++i) {
    gdjs.GameCode.GDFlashObjects1[i].getBehavior("Flash").Flash(0.1, null);
}
}
{ //Subevents
...
gdjs.copyArray(runtimeScene.getObjects("YellowJellyButton"), gdjs.GameCode.GDYellowJellyButtonObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDYellowJellyButtonObjects1.length;i<l;++i) {
    if ( gdjs.GameCode.GDYellowJellyButtonObjects1[i].IsClicked(null) ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDYellowJellyButtonObjects1[k] = gdjs.GameCode.GDYellowJellyButtonObjects1[i];
        ++k;
    }
}
gdjs.GameCode.GDYellowJellyButtonObjects1.length = k;
if (isConditionTrue_0) {
...
gdjs.GameCode.GDYellowJellyButtonObjects2.length = 0;
gdjs.GameCode.GDYellowJellyButtonObjects3.length = 0;
gdjs.GameCode.GDYellowJellyButtonObjects4.length = 0;
